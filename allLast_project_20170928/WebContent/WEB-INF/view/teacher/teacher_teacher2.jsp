			...
			<div id="page-inner">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<!-- 						<button type="button" class="btn btn-default btn-xs btnRoom" data-toggle="modal"
						data-target="#roomModal">과목 등록</button> -->
					</div>
					<div id="demo"></div>
				</div>
				<!-- 
				div id="demo"부분이 있어야 sub메뉴가 나온다 
				$(".btninfo").on("click", function()
				{ $.get("teacher_subject.jsp", function(data) {
				$("div#demo").html(data);
				이부분이 적용됨
				 -->
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default btn-sm" id="">등록</button>
